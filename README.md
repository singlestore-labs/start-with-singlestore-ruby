Getting started with SingleStore and Ruby
=========================================


Whether you're using an ORM or framework like Rails or straight SQL, you can get started with SingleStore (formerly MemSQL) fast. Here's an introductory sample of using SingleStore with Ruby. This sample includes all the CRUD methods: Create, Read by id, Read all, Update, and Delete.
...
3. Adjust the connection details in `app.rb`, `bundle install`, and run it.
